  ...
  return (
    <section id="about-hero" className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 flex flex-col items-start justify-end p-8 text-white sm:p-12 lg:p-24">
        ...
        <a
          href="#about-content"
          className="group mt-4 flex items-center gap-2 text-sm font-light uppercase tracking-widest"
        >
          <svg
      ...
      <div id="about-content" className="bg-white">
        <div className="container mx-auto max-w-screen-xl py-24 px-4 sm:px-6 lg:py-32">
          ...
          <div className="mt-12 space-y-8 text-base text-foreground">
            ...
            <p>
              The One Earth Enterprises serves as a holding and operating
            ...
            <p>
              In the e-commerce space, The One Earth Enterprises focuses on
            ...
            <p>
              At the heart of The One Earth Enterprises is a strong commitment
            ...
            <p>
              ...
              long-term thinking and a founder-led mindset, The One Earth
              Enterprises seeks opportunities that align with our values and our
