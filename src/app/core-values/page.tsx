...
export const metadata: Metadata = {
  title: 'Responsibility | novo holdings',
  description:
...
const sections = [
  ...
  },
  {
    ...
    content:
      'At the heart of novo holdings is a strong commitment to governance, transparency, and trust. We believe that a parent company’s responsibility extends beyond growth to include accountability, ethical leadership, and sustainable value creation. Our governance frameworks support disciplined capital allocation and risk management across all verticals.',
    imageId: 'core-value-governance',
  },
  {
    title: 'An Integrated Enterprise Built for the Future',
    content:
      'As we continue to expand, our vision remains rooted in building an integrated group of businesses that complement one another and contribute meaningfully to the broader economy. Guided by long-term thinking and a founder-led mindset, novo holdings seeks opportunities aligned with our values, building enterprises designed to endure and grow responsibly.',
