...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p class="mb-4">For organizations to thrive, they must adopt a mindset of continuous adaptation. This means not just implementing new technologies, but also fostering a culture of innovation that empowers teams to experiment, learn, and iterate. At novo holdings, our IT services vertical is dedicated to helping our partners navigate this complex journey.</p>
  ...
  },
  {
    ...
    content: `
      <p class="mb-4">In a market often driven by short-term gains, our real estate philosophy at novo holdings is deliberately different. We believe that real estate is not about quick flips; it is about creating places that stand the test of time, add value to communities, and deliver sustainable returns over the long run.</p>
